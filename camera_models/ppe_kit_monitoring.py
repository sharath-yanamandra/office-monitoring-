...
from camera_models.kalman_track import Sort # Assuming kalman_track.py is in the same folder
...
class PPEDetector(CameraModelBase):
    ...
    def __init__(self, camera_id, zones=None, rules=None, settings=None, db=None, 
        ...
        self.person_tracker = Sort(max_age=30, min_ma=3)
        self.violation_tracker = Sort(max_age=30, min_ma=3)
