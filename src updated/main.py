...
async def test_system_health():
    ...
    try:
        ...
        try:
            ...
            print(f"   ✓ FPS limits: High={Config.ACTIVITY_LEVEL_HIGH}, "
                  f"Med={Config.ACTIVITY_LEVEL_MEDIUM}, Low={Config.ACTIVITY_LEVEL_LOW}")
            print(f"   ✓ PPE detection: {'Enabled' if Config.PPE_DETECTION_ENABLED else 'Disabled'}")
        ...
        try:
            if os.path.exists(Config.DETECTION_MODEL_PATH):
                print(f"   ✓ Detection model found: {Config.DETECTION_MODEL_PATH}")
            else:
                print(f"   ✗ Detection model missing: {Config.DETECTION_MODEL_PATH}")
            
            if Config.PPE_DETECTION_ENABLED:
                if os.path.exists(Config.PPE_DETECTION_MODEL_PATH):
                    print(f"   ✓ PPE model found: {Config.PPE_DETECTION_MODEL_PATH}")
                else:
                    print(f"   ✗ PPE model missing: {Config.PPE_DETECTION_MODEL_PATH}")
        except Exception as e:
