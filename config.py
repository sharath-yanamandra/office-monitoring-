...
class Config:
    ...
    POSE_ESTIMATION_MODEL_PATH = os.getenv('POSE_ESTIMATION_MODEL_PATH')
    PPE_DETECTION_MODEL_PATH = os.getenv('PPE_DETECTION_MODEL_PATH')
    POSE_ENABLED = os.getenv('POSE_ENABLED', 'false').lower() == 'true'

    # Detection Thresholds - ADD THESE MISSING CONSTANTS
    ...
    GCP_PROJECT = os.getenv('GCP_PROJECT', 'your-datacenter-project')
    POSE_ENABLED = os.getenv('POSE_ENABLED', 'false').lower() == 'true'
    ...
    MOTION_AREA_THRESHOLD = 0.02  # 2% of frame area
    ...
    LOCAL_RTSP_URL = "rtsp://admin:password@192.168.29.212:554/ch0_0.264"  # Update with your camera URL
