...
class DatacenterCameraModelBase:
    ...
    def __init__(self, camera_id, zones=None, rules=None, settings=None, db=None, 
        ...
        self.object_tracker = Sort(
            ...
            min_ma=DatacenterConfig.MIN_MA
        )
        ...
        self.recording_cooldown = DatacenterConfig.EVENT_COOLDOWN  # seconds
        ...
        self.recent_events = {}
        self.tracking_threshold = self.settings.get('tracking_threshold', DatacenterConfig.TRACKING_THRESHOLD)
        self.media_preference = self.settings.get('media_preference', DatacenterConfig.MEDIA_PREFERENCE)
        self.event_cooldown = self.settings.get('event_cooldown', DatacenterConfig.EVENT_COOLDOWN)
        ...
        try:
            ...
            if hasattr(self.camera_manager, 'queue_event_recording'):
                ...
                recording_queued = self.camera_manager.queue_event_recording(
                    ...
                    past_seconds=DatacenterConfig.VIDEO_BUFFER_PAST_SECONDS,
                    future_seconds=DatacenterConfig.VIDEO_BUFFER_FUTURE_SECONDS,
    ...
    def _queue_event(self, event_type, detections, timestamp, zone_name=None, event_id=None, video_path=None, video_duration=None):
        ...
        try:
            ...
            if video_path:
                ...
                event_data['video_duration'] = video_duration or DatacenterConfig.VIDEO_BUFFER_PAST_SECONDS + DatacenterConfig.VIDEO_BUFFER_FUTURE_SECONDS
